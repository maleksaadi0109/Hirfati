    ...
    return (
        <div className="absolute inset-0 overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-20 left-10 w-[500px] h-[500px] bg-gradient-to-br from-orange-500/40 to-amber-500/35 rounded-full blur-3xl"
            />
            <motion.div
                animate={{
                    x: [0, -120, 80, 0],
                ...
                style={{ willChange: 'transform' }}
                className="absolute top-1/2 right-10 w-[600px] h-[600px] bg-gradient-to-br from-sky-500/25 to-cyan-500/25 rounded-full blur-3xl"
            />
            <motion.div
                animate={{
                    x: [0, 60, -80, 0],
...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-stone-50 via-white to-orange-50/30 font-['Sora',ui-sans-serif,system-ui] selection:bg-orange-200 relative">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 sm:p-10 lg:p-14 xl:p-20 relative z-10 bg-white/95 min-h-screen">
                <motion.div
                    id="register-form"
                    initial="hidden"
                    animate="visible"
                ...
                >
                    ...
                    <motion.div variants={fadeInLeft} className="mb-8">
                        ...
                        <h1 className="text-3xl sm:text-5xl font-bold text-slate-900 mb-4 tracking-tight leading-[1.1]">
                            Create your<br />
                    ...
                    >
                        ...
                        >
                            <Link
                                ...
                                className="group relative w-full h-14 flex items-center justify-center border-2 border-slate-200 hover:border-orange-300 text-slate-700 hover:text-orange-600 font-bold rounded-xl transition-all hover:bg-gradient-to-br from-orange-50 to-amber-50 shadow-sm hover:shadow-lg overflow-hidden"
                            >
                                <span className="relative z-10 flex items-center gap-2">
                                    Sign In
                                    <Sparkles className="w-4 h-4 group-hover:rotate-12 transition-transform" />
                                </span>
                                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 opacity-0 group-hover:opacity-10 transition-opacity" />
                            </Link>
                        </motion.div>
                    </motion.form>
                </motion.div>
            ...
            <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden sticky top-0 h-screen">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-12 xl:p-20 z-10">
                    ...
                    >
                        <div className="mb-10">
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/30 to-amber-500/30 backdrop-blur-xl px-5 py-3 rounded-full mb-8 border border-orange-500/30 shadow-2xl"
                            >
                                <motion.div
                                    animate={{ rotate: 360 }}
                    ...
                    >
                        <span>&copy; 2026 Hirfati Inc.</span>
