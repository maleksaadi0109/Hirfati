...
<head>
    ...
    <title>Application Approved - Welcome to Hirfati!</title>
    <!--[if mso]>
    <style type="text/css">
                    ...
                    <tr>
                        <td style="background-color: #ffffff; padding: 40px 40px 0 40px; text-align: center;">
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #f0fdf4, #ecfdf5); border: 1px solid #a7f3d0; border-radius: 100px; padding: 8px 20px;">
                                        <span style="font-size: 13px; font-weight: 700; color: #16a34a; letter-spacing: 0.5px;">🎉 Application Approved</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="background-color: #ffffff; padding: 32px 40px 40px 40px;">
                            ...
                            <h2 style="margin: 0 0 20px 0; font-size: 28px; font-weight: 800; color: #0f172a; letter-spacing: -0.5px; line-height: 1.3;">
                                Great news, {{ $user->first_name ?? 'there' }}! 👋
                            </h2>

                            <p style="margin: 0 0 20px 0; font-size: 16px; color: #475569; line-height: 1.7;">
                                We are absolutely thrilled to inform you that your application to join <strong style="color: #0f172a;">Hirfati</strong> as a professional provider has been <strong style="color: #16a34a;">approved</strong>!
                            </p>

                            <p style="margin: 0 0 32px 0; font-size: 16px; color: #475569; line-height: 1.7;">
                                You can now access your provider dashboard, list your services, and start connecting with clients across Libya.
                            </p>
                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: top;">
                                                                <p style="margin: 0 0 4px 0; font-size: 15px; font-weight: 700; color: #0f172a;">Set Up Your Services</p>
                                                                <p style="margin: 0; font-size: 13px; color: #64748b; line-height: 1.5;">Finish setting up your profile to attract more clients.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 8px 0 32px 0;">
                                        <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ config('app.url') }}/dashboard" style="height:56px;v-text-anchor:middle;width:280px;" arcsize="21%" fillcolor="#16a34a">
                                        <center style="color:#ffffff;font-family:sans-serif;font-size:17px;font-weight:bold;">Go to Dashboard →</center>
                                        </v:roundrect>
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{{ config('app.url') }}/dashboard" class="button-link" style="background: linear-gradient(135deg, #16a34a 0%, #10b981 100%); color: #ffffff; text-decoration: none; padding: 18px 48px; border-radius: 14px; font-size: 17px; font-weight: 700; display: inline-block; box-shadow: 0 10px 25px -5px rgba(22, 163, 74, 0.4); letter-spacing: 0.3px; mso-hide: all;">
                                            Go to Dashboard →
                                        </a>
                                        <!--<![endif]-->
                                    </td>
                                ...
                                <tr>
                                    <td style="border-top: 1px solid #e2e8f0; padding-top: 24px;">
                                        <p style="margin: 0 0 4px 0; font-size: 15px; color: #475569; line-height: 1.7;">
                                            We are excited to see you grow your business with us!
                                        </p>
